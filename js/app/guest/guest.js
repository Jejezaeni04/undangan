...
export const guest = (() => {
    ...
    const buildGoogleCalendar = () => {
        ...
        const data = new URLSearchParams({
            action: 'TEMPLATE',
            text: 'The Walimatul Khitanan Ghibran Muhammad Al-fatih',
            dates: `${formatDate('2025-07-03 11:00')}/${formatDate('2025-07-03 11:00')}`,
            details: 'Tanpa mengurangi rasa hormat, kami mengundang Anda untuk berkenan menghadiri acara walimatul khitanan anak kami. Terima kasih atas perhatian dan doa restu Anda, yang menjadi kebahagiaan serta kehormatan besar bagi kami.',
            location: 'RT 02 RW 06, Kampung Pedurenan, Kelurahan Pabuaran, Cibinong.',
            ctz: config.get('tz'),
        });
